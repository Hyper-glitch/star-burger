...
Определите переменную окружения `SECRET_KEY` и `YANDEX_GEOCODER_API_KEY` ([секретный ключ API yandex geocoder](https://developer.tech.yandex.ru/services/)).
...
- `YANDEX_GEOCODER_API_KEY` — [секретный ключ API yandex geocoder](https://developer.tech.yandex.ru/services/)
